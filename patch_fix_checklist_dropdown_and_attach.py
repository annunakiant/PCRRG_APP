...
# ------------------------------------------------------------
# 1) PATCH view_job route to pass JobTaskTemplate list
# ------------------------------------------------------------
with open("app.py", "r", encoding="utf-8") as f:
    code = f.read()

# Insert task_templates if missing
...
print("✔ Checklist dropdown + attach route fully fixed.")
